...
//			Init mode				//
  ...
  //FOFO0
	...
	CAN1->sFilterRegister[4].FR1=0x6E306E20;	//Filters bank 4 fmi 04 ID=0x371 IDE=0 RTR=0	//  UPDATE_FIRMWARE_REQ 
																						//							 fmi 05 ID=0x373 IDE=0 RTR=1
	CAN1->sFilterRegister[4].FR2=0x6E706E60;	//Filters bank 4 fmi 06 ID=0x373 IDE=0 RTR=0	 //	DOWNLOAD_FIRMWARE
																						//							 fmi 07 ID=0x373 IDE=0 RTR=1
